export default function MapSection() {
  return (
    <div className="relative w-full max-w-5xl mx-auto mt-20 mb-20">
      ...
      <div className="backdrop-blur-xl bg-brown border border-white/10 rounded-xl px-4 py-3  shadow-lg">
      <h3 className="font-bree text-cream ">Nalazimo se ovde</h3>
      <p className="text-xs text-cream font-semibold">Gornja Tresnjica, Srbija</p>
      </div>
      </div>
      ...
      <div className="md:hidden mt-4 bg-dhoney text-white p-4 rounded-xl border border-white/10">
        <h3 className="font-semibold text-brownt font-bree">Posetite nas</h3>
        <p className="text-sm text-brownt ">Gornja Tresnjica, Srbija</p>

        <a
          href="https://www.google.com/maps?q=44.1200345,19.48342"
          target="_blank"
          className="inline-block mt-2 text-sm text-brownt hover:underline "
        >
